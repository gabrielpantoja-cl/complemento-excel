...
- **Bundled extension-authoring guidance**
  ...
  - Added secure API-extension template guide (`docs/features/extensions-secure-connection-bundle.md`).
  - Guidance now defaults to `/tools â†’ Connections` secret setup and host-managed auth flows.
