...
- [ ] **SIGUIENTE:** volver a Partner Center → "Login with work account" → usar `GabrielPantoja@Loxos365.onmicrosoft.com`
- [ ] Completar registro Office Store (aceptar términos)
